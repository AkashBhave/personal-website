              ...
              <div>
                ...
                <ul className="my-1 ml-4 list-inside list-disc">
                  {formErrors.map((error) => (
                    <li key={error.split(" ").join("-").toLowerCase()}>
                      {error}
                    </li>
                  ))}
                </ul>
            ...
            <div className="-mx-4">
                ...
                <div className="w-full px-4">
                  ...
                  <div className={styles.formEditor}>
                    {typeof window !== "undefined" ? (
                      <ReactQuill value={formEditor} onChange={setFormEditor} />
                    ) : null}
                  </div>
                </div>
              </div>
              <div className="flex flex-wrap">
                <div className="w-full px-4">
                  ...
                  <ReCAPTCHA
                    sitekey={process.env.GATSBY_RECAPTCHA_SITE}
          ...
          <div className="container w-full mx-auto text-center">
            {formResponse === true ? (
              <div>
                ...
                <div className="mt-2 text-lg">Thanks for the message!</div>
              </div>
            ) : (
              <div>
